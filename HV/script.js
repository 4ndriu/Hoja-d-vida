...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Selecciona el botón con id="tema-camb" (el botón que cambia el tema)
  const toggleBtn = document.getElementById('tema-camb');

  // Agrega un "escuchador" de eventos para el clic en el botón
  toggleBtn.addEventListener('click', function () {
    // Cambia (agrega o quita) la clase "dark-mode" en el <body>
    document.body.classList.toggle('mod-oscuro');
